const serverUrl = "https://20r4o4fubkgu.usemoralis.com:2053/server"; //Server url from moralis.io
const appId = "AJtSlSTh2okU29lwFxZUz2NQckgmtR80FZIdD7Xl"; // Application id from moralis.io
...
async function login() {
  ...
  document.getElementById("btn-login").onclick = copyAddress;  
  $(function () {
 ...
 async function logOut() {
  ...
  async function copyAddress() {
      ...
      var str = document.getElementById("btn-login").innerText;
      // Create new element
